    ...
    <main className="min-h-screen bg-surface">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 overflow-hidden">
        ...
        <div className="relative max-w-2xl text-center z-10">
          ...
          <h1 className="font-serif text-5xl md:text-7xl lg:text-8xl text-ink mb-8 animate-fade-in-up delay-2" style={{ letterSpacing: '-0.03em', fontWeight: 600 }}>
            The Eden Project
          </h1>

          <p className="text-2xl md:text-3xl text-ink-secondary leading-relaxed max-w-lg mx-auto mb-12 animate-fade-in-up delay-3">
      ...
      <section id="more" className="relative py-32 md:py-40 px-6">
        <div className="relative max-w-xl mx-auto text-center">
          <p className="font-serif text-3xl md:text-5xl text-ink leading-tight mb-10">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-16">
            <div className="text-center">
              ...
              <h3 className="font-serif text-2xl text-ink mb-3">Fifteen questions</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="font-serif text-2xl text-ink mb-3">A framework meets your words</h3>
              <p className="text-lg text-ink-secondary leading-relaxed">
            ...
            <div className="text-center">
              ...
              <h3 className="font-serif text-2xl text-ink mb-3">A document written for you</h3>
              <p className="text-lg text-ink-secondary leading-relaxed">
      ...
      <section className="relative py-32 px-6 bg-surface-secondary">
        ...
        <div className="relative max-w-2xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-ink-secondary leading-relaxed mb-12">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {['Philosophy', 'Theology', 'Science', 'Literature', 'Mysticism', 'Psychology'].map((tag, i) => (
              <span
                key={i}
                className="text-sm tracking-[0.15em] uppercase text-ink-secondary border border-white/[0.2] rounded-full px-5 py-2"
              >
                {tag}
              </span>
            ))}
      ...
      <section className="relative py-32 px-6">
        <div className="relative max-w-2xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-ink-secondary leading-relaxed mb-6">
      ...
      <section className="relative py-32 px-6 bg-surface-secondary">
        <div className="relative max-w-xl mx-auto text-center">
          ...
          <p className="font-serif text-2xl md:text-3xl text-ink mb-6">
            Curious? Talk to it first.
          </p>

          <p className="text-lg md:text-xl text-ink-secondary mb-10 leading-relaxed">
      ...
      <section className="relative py-24 px-6 border-t border-white/[0.12]">
        <div className="relative max-w-xl mx-auto text-center">
          <p className="text-lg md:text-xl text-ink-secondary mb-6">
